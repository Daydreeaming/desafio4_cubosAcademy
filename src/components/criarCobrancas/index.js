				...
				<form className="form_charges">
					<div className="fill_form">
						<div className="field_charges">
								<span>Cliente</span>
								<select>
									<option value="" disabled selected>Selecione a cliente</option>
						...
						<div className="field_charges">
							<span>Descrição</span>
							<input type="email" placeholder="Referente ao pagamento da compra online."></input>
						...
						<div className="buttons_form">
							...
							<Link to="#" className="button_form2">Criar cobranças</Link>
						</div>
					</div>
				</form>
			</div>
